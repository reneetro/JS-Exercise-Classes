...
class Car {
  ...
  drive(distance) {
    ...
    this.tank = this.tank - (distance/this.milesPerGallon);
      ...
      this.tank = 0;
      return `I ran out of fuel at ${startingD-distancePossible} miles!`;
    }
  }
}
...
const x = new Instructor ({
  name: 'bob',
  age: 24,
  location: 'home',
  specialty: 'JS',
  favLanguage: 'Finnish',
  catchPhrase: 'Stone Cold Steve Austin'
});

console.log('demo', x.demo('math'));/*
  TASK 5
